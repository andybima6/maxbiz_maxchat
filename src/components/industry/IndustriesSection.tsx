...
import ngoImg from "@/assets/hero-ngo.jpg";
import cooperativeImg from "@/assets/hero-cooperative.jpg";
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Solusi ERPNext yang dapat disesuaikan untuk berbagai sektor industri, 
            membantu organisasi meningkatkan efisiensi operasional dan pertumbuhan bisnis.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
          {industries.map((industry, index) => (
            <Card
              key={index}
              className="group overflow-hidden hover:shadow-elegant transition-all duration-300 hover:-translate-y-2 border-border/50 bg-card"
            >
