...
const mainModules = [
  ...
  },
  {
    ...
    image: crmSolution,
    features: [
      "Funneling prospek yang efisien",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">
            Solusi <span className="text-primary">MaxBiz ERP</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
            MaxBiz ERP dirancang untuk menyederhanakan operasional bisnis Anda melalui modul-modul terintegrasi yang 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {mainModules.map((module, index) => {
              ...
              return (
                <Card 
                  key={module.id}
                  className="group hover:shadow-colored transition-all duration-500 border-0 overflow-hidden animate-slide-up hover:-translate-y-2"
        ...
        <div className="text-center bg-gradient-hero  backdrop-blur-sm rounded-3xl p-12 border border-border/50 animate-scale-in">
          <h3 className="text-2xl lg:text-3xl font-bold text-foreground mb-4 text-white">
            Siap Mengoptimalkan Bisnis Anda?
          </h3>
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto text-white">
            Jelajahi semua modul MaxBiz ERP dan temukan paket yang sesuai dengan kebutuhan bisnis Anda.
          </p>
