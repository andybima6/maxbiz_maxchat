      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Bergabunglah dengan 100+ perusahaan Indonesia yang sudah meningkatkan efisiensi bisnis dengan MaxBiz. Konsultasi gratis, implementasi mudah, support lokal 24/7.</p>
          </div>
