      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Tiga pilar utama yang menjadikan MaxBiz partner terpercaya untuk transformasi digital bisnis Anda
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {advantages.map((advantage, index) => {
            ...
            return (
              <Card 
                key={advantage.id}
                className={`group hover:shadow-colored transition-all duration-500 border-0 overflow-hidden animate-slide-up ${hasImage ? 'row-span-2' : ''}`}
              ...
              >
                ...
                <CardContent className="p-8 text-center space-y-6">
                  ...
                  <h3 className={`text-xl font-bold text-${advantage.color}`}>
                    {advantage.title}
                  </h3>
