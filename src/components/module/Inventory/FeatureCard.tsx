      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold">
            Powerful Features for <span className="bg-gradient-hero bg-clip-text text-transparent">Modern Inventory</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Everything you need to manage your warehouse operations efficiently</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-elegant transition-all duration-300 border-2 hover:border-primary/50 bg-card">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-20">
          <div className="relative order-2 lg:order-1">
            ...
            <img src={dashboardMockup} alt="Inventory management dashboard interface" className="relative rounded-2xl shadow-elegant w-full h-auto" />
          </div>
          <div className="space-y-6 order-1 lg:order-2">
            <h3 className="text-3xl md:text-4xl font-bold">
              Powerful Dashboard for <span className="bg-gradient-primary bg-clip-text text-transparent">Real-Time Insights</span>
            </h3>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Monitor your entire inventory ecosystem from a single, intuitive dashboard. Track stock levels, manage orders, and make data-driven decisions with real-time analytics and customizable reports.
            </p>
