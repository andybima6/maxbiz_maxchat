        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 max-w-6xl mx-auto">
          {supportingFeatures.map((feature, index) => {
            ...
            return (
              <Card
                key={feature.id}
                className="group hover:shadow-medium transition-all duration-500 border-0 hover:-translate-y-2 animate-slide-up bg-card/50 backdrop-blur-sm"
                style={{ animationDelay: `${(index + mainFeatures.length) * 100}ms` }}
              >
